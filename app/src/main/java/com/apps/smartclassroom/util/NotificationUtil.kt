package com.apps.smartclassroom.util
...
import com.apps.smartclassroom.ui.timer.AppConstants
import com.apps.smartclassroom.ui.timer.TimerNotificationActionReceiver
    ...
    companion object {
        ...
        fun showTimerExpired(context: Context){
            ...
            nBuilder.setContentTitle("Timer Expired!")
                    ...
                    .setContentIntent(getPendingIntentWithStack(context, QuizActivity::class.java))
                    .addAction(R.drawable.ic_exam, "Start", startPendingIntent)
        ...
        fun showTimerRunning(context: Context, wakeUpTime: Long){
            ...
            val nManager = context.getSystemService(Context.NOTIFICATION_SERVICE) as NotificationManager
            nManager.createNotificationChannel("EXAM", "EXAM TIMER", true)
